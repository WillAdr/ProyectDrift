...
public class RopaFragment extends Fragment implements ProductoAdapter.Listener {

    private FragmentSlideshowBinding binding;
    private RopaViewModel vm;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        vm = new ViewModelProvider(this).get(RopaViewModel.class);
        ...
        vm.getRopa().observe(getViewLifecycleOwner(), adapter::setLista);
    ...
    private void mostrarDialogoProducto(@Nullable ProductoEntity productoEditar) {
        ...
        new AlertDialog.Builder(requireContext())
                .setTitle(esEdicion ? "Editar prenda" : "Agregar prenda")
                .setView(d.getRoot())
                .setPositiveButton(esEdicion ? "Guardar" : "Agregar", (dialog, which) -> {
                    ...
                    if (esEdicion) {
                        ...
                        vm.insertar(new ProductoEntity("ROPA", nombre, desc, precio, imagen));
                    }
                })
    ...
    @Override public void onEditar(ProductoEntity producto) { if (sesion.esAdmin()) mostrarDialogoProducto(producto); }
